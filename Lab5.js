...
const Lab5 = (app) => {
  //now implementing app terms in the correct way..
  ...
  //3.5.2 updated way to delete tasks
  ...
  //old unrecommended way to delete
  ...
  //query parameters
  app.get("/a5/calc", (req, res) => {
    const { c, d, operation } = req.query;
    let result = 0;
    switch (operation) {
      case "multiply":
